...
//$message = "Viewing hall of fame for {REPLACE_ME}";
$message="";
if (!$tab) $tab=1;
//include('../header.htm');
...
if ($lastBattleDone)
{
  ...
  if ($lb['winner'] == "Shadow")
  {
    echo "The Shadow has fallen over the pattern. Hail the Great Lord!.";
  }
  else
  {
    echo "The Light has prevailed over the Shadow. The Wheel turns.";
  }
  echo "</b></center>";
}
?>
              ...
              <div class="panel panel-success">
                ...
                ?>
                    <tr>
                      ...
                      <td valign='bottom'>
                        <a class='btn btn-xs btn-block btn-wrap <?php echo $classn; ?>' unused="bio.php?name=<?php echo $listchar['name']; echo "&amp;last="; echo $listchar['lastname']; echo "&amp;time="; echo time(); ?>"><?php echo $listchar['name']." ".$listchar['lastname']; ?>
              ...
              <div class="panel panel-success">
                ...
                ?>
                    <tr>
                      ...
                      <td valign='bottom'>
                        <a class='btn btn-xs btn-block btn-wrap <?php echo $classn; ?>' unused="joinclan.php?name=<?php echo $listsoc['name'];?>"><?php echo $listsoc['name'];?>
