  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="checkbox">
        ...
        2. I will not create more than one account per person.<br/>
        3. I will not create characters for the purpose of furthering other characters or clans.<br/>
        4. I will try my best to not exploit any bugs.<br/>
        </p>
      </div>
      <input type="Submit" name="submit" value="Create New Account" class="btn btn-success">
    </div>
  </div> 
</form>  
