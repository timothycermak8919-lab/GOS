...
mysqli_query($db, "UPDATE Users SET newachieve=0 WHERE id=$id");
        ...
        <div class="col-sm-12">
            <div id="content">
                <ul id="achievtabs" class="nav nav-tabs" data-tabs="tabs">
                    <li <?php if ($tab == 1) echo "class='active'"; ?>><a href="#recent_tab"
                                                                          data-toggle="tab">Recent</a></li>
                    <li <?php if ($tab == 2) echo "class='active'"; ?>><a href="#achieve_tab" data-toggle="tab">Achievements</a>
                    </li>
                </ul>
                                ...
                                if ($abox[$y]['id']) {
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class='row'>
                                                <a class='col-xs-3 btn btn-primary btn-xs btn-wrap'
                                                   href="bio.php?name=<?php echo $sender['name'] . "&last=" . $sender['lastname']; ?>"><?php echo $sender['name'] . " " . $sender['lastname'] . " (" . $senttime; ?>
                                                    )</a>
                                                <a class='col-xs-7 btn btn-default btn-xs btn-wrap'
                                                   data-toggle="collapse" data-parent="#accordion_ach"
                                                   href="#<?php echo $accord; ?>"><h4
                                                            class="panel-title"><?php echo $cursub; ?></h4></a>
                                            </div>
                                        </div>
