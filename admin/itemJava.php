...
function displayGold (money, txt)
{
  ...
  if (txt==0)
    rval += "<img src='https://gameofstones.app/images/gold.gif' width='15' style='vertical-align:middle' alt='g:'>"+crown+"<img src='https://gameofstones.app/images/silver.gif' width='15' style='vertical-align:middle' alt='s:'>"+mark+"<img src='https://gameofstones.app/images/copper.gif' width='15' style='vertical-align:middle' alt='c:'>"+penny+"</font>";
  else
  {
