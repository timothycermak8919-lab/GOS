...
{ 
  ...
  $itmVal = item_val(iparse(inv[prod][0],inv[prod][1],inv[prod][2],inv[prod][3]));
  if($itmVal==0){
    $itmVal=item_base[inv[prod][0]][2];
  }
  document.getElementById('proval'+sub+'b'+pro).innerHTML= "<center><font class='littletext'>"+displayGold($itmVal,0)+"</font></center>"; 
  //document.getElementById('proval'+sub+'b'+pro).innerHTML= "<center><font class='littletext'>"+$itmVal+"</font></center>"; 
}
